...
if (isset($_POST['submit'])) {
    ...
    $rec_id = mysqli_real_escape_string($con, $_POST['rec_id']); // Assuming you are getting this value from the form
    ...
    if (mysqli_num_rows($result_check) > 0) {
        $sql = "INSERT INTO `orders` (med_name, brand_name, Quantity, rec_id) VALUES ('$medicine', '$brand', '$quantity', '$rec_id')";
